...
def load_data(**kwargs):
    ...
    conn = sqlite3.connect('/home/linnea/airflow/weather_data.db')
    cursor = conn.cursor()
    ...
    ''')
    # Sort the daily_df DataFrame in descending order by formatted_date
    daily_df = daily_df.sort_values(by='formatted_date', ascending=False)

    # Sort the monthly_df DataFrame in descending order by month
